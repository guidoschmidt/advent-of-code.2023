...
fn part2(input: []const u8) void {
    ...
    // Time
    var time_row = std.mem.replaceOwned(u8, allocator, row_it.next().?, " ", "") catch ""; 
    ...
    // Distance
    var dist_row = std.mem.replaceOwned(u8, allocator, row_it.next().?, " ", "") catch "";
...
pub fn main() !void {
    try common.runDay(allocator, 6, part1, part2);
}
